...
def parse(pdf_path: Path) -> tuple[str, float]:
    """Parse a PDF with LlamaParse and return (markdown, parse_time_seconds)."""
...
if __name__ == "__main__":
    ...
    load_dotenv()  # load LLAMA_CLOUD_API_KEY from .env file
    ...
    with open("output_llamaParse.md", "w") as f:
        f.write(markdown)
